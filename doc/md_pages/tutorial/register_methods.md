...
~~~~{.cpp}
    template<typename F>
    rttr::registration::bind rttr::registration::method(std::string_view name, F function);
~~~~
...
- calling @ref rttr::type::invoke(std::string_view, std::vector< argument >) "type::invoke()" from the [type](@ref rttr::type) class.
- retrieving first a @ref rttr::method "method" object from @ref rttr::type::get_global_method(std::string_view, const std::vector< type >&) "type::get_global_method()" and then calling invoke
...
The @ref rttr::type::invoke(std::string_view, std::vector< argument >) "type::invoke()" function will internally try 
...
The return value of @ref rttr::type::invoke(std::string_view, std::vector< argument >) "type::invoke()" is a @ref rttr::variant "variant" object.
...
When you prefer to hold a handle to the function use the getter @ref rttr::type::get_global_method(std::string_view, const std::vector< type >&) "type::get_global_method()"
