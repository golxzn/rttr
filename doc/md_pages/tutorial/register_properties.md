...
~~~~{.cpp}
    template<typename A>
    registration rttr::registration::property( std::string_view name, A accessor );
  
    template<typename A>
    registration rttr::registration::property_readonly(std::string_view name, A accessor);
~~~~
...
Therefore the @ref rttr::registration::property(std::string_view, A1, A2) "property()" function is overloaded.

It has following synopsis:
~~~~{.cpp}
    template<typename A1, typename A2>
    registration rttr::registration::property( std::string_view name, A1 getter, A2 setter );
~~~~
- `name` is the name of the property
...
- calling @ref rttr::type::set_property_value(std::string_view, argument) "type::set_property_value()" and @ref rttr::type::get_property_value(std::string_view) "type::get_property_value()" from the @ref rttr::type "type" class or
- retrieving a @ref rttr::property "property" object from @ref rttr::type::get_global_property(std::string_view) "type::get_global_property()" and then calling @ref rttr::property::set_value() "property::set_value()" and @ref rttr::property::get_value() "property::get_value()"
...
The static @ref rttr::type::set_property_value(std::string_view, argument) "type::set_property_value()" function
...
@ref rttr::type::get_property_value(std::string_view) "type::get_property_value()". 
...
Another option is to retrieve a handle to the property via @ref rttr::type::get_global_property(std::string_view) "type::get_global_property()".
